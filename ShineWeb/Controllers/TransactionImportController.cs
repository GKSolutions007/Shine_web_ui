    ...
    public class TransactionImportController : Controller
    {
        ...
        public ActionResult Index(string Name, string strFormID)
        {
            ...
            else
            {
                ...
                bool Formhaveanypermission = dtPermission.Select("MenuId = 486", null).Length > 0;
                if (!Formhaveanypermission && UID != 1)
                {
                    return RedirectToAction("nopermission", "Home",
                        new { emanmrofnoissimerpon = "IdvuTHUDMGifNeTpy7RWwHyRimA5g+NCOshijp8vqNt3JHIp8gWK6sKERZH3Xoc8" });
                }
