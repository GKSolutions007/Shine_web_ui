    ...
    public class QuotationController : Controller
    {
        ...
        public ActionResult Index(string Name, string strFormID, string TypeID, string TranID, string TransVariantID = "0", string PartyID = "0")
        {
            ...
            else
            {
                ...
                bool Formhaveanypermission = dtPermission.Select("MenuId = 144 or MenuParentId = 144", null).Length > 0;
                if (!Formhaveanypermission && UID != 1)
                {
                    return RedirectToAction("nopermission", "Home",
                        new { emanmrofnoissimerpon = "BTQgLv+ebY48FN9pEezgnyVrVumuVVzPVnoCFOjqIsU=" });
                }
                ...
                string DrftMod = dtPermission.Select("MenuID = 386", null).Length > 0 || UID == 1 ? "1" : "0";
                string DrftCan = dtPermission.Select("MenuID = 387", null).Length > 0 || UID == 1 ? "1" : "0";
