    ...
    public class SalesmanMasterController : Controller
    {
        ...
        public ActionResult Index(string Name, string strFormID, string TypeID, string TranID, string ID = "0", string DepFrom = "0")
        {
            ...
            else
            {
                ...
                bool Formhaveanypermission = dtPermission.Select("MenuId = 78 or MenuParentId = 78", null).Length > 0;
                if (!Formhaveanypermission && UID != 1)
                {
                    return RedirectToAction("nopermission", "Home",
                        new { emanmrofnoissimerpon = "r8yIwuCefL0RbL6dbkzV7hS653HRxUkWTEY0xpdlCgc=" });
                }
